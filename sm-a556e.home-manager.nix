...
in
{
  ...
  # home.packages = [
  #   (pkgs.writeShellScriptBin "glide" ''
  #     exec ${inputs.glide-browser.packages.${pkgs.stdenv.hostPlatform.system}.glide-browser}/bin/glide \
  #       --profile /home/rok/.glide/glide/default "$@"
  #   '')
  # ];
