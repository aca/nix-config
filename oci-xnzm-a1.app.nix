...
let
  _default = {
    ...
    serviceConfig.EnvironmentFile = "/home/rok/src/git.internal/bot/.env";
...
in
{
  # systemd.services."mstrgrid" = lib.recursiveUpdate bot {
  #   serviceConfig.ExecStart = "go run ./bitget/mstrgrid";
  # };
  #
  ...
  # };
  #
  # systemd.services."tb-nvdaon" = lib.recursiveUpdate bot {
  #   serviceConfig.ExecStart = "go run ./bitget/tb-spot NVDAONUSDT";
  # };
  #
  # systemd.services."tb-amznon" = lib.recursiveUpdate bot {
  #   serviceConfig.ExecStart = "go run ./bitget/tb-spot AMZNONUSDT";
  # };
  #
  # systemd.services."tb-aaplon" = lib.recursiveUpdate bot {
  #   serviceConfig.ExecStart = "go run ./bitget/tb-spot AAPLONUSDT";
  # };
  #
  # systemd.services."tb-qqqon" = lib.recursiveUpdate bot {
  #   serviceConfig.ExecStart = "go run ./bitget/tb-spot QQQONUSDT";
  # };
  #
  ...
  # };
  systemd.services."sleep" = lib.recursiveUpdate bot {
    serviceConfig.ExecStart = "go run ./cmd/sleep";
  };
  #
