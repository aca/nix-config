...
in {
  ...
  #     Type = "exec";
  #     ExecStart = ''
  #       /run/current-system/sw/bin/ssh -v -D 1337 -q -C root@oci-xnzm1001-002 "sh -c 'while :; do echo 1; sleep 2073600; done'"
  #       sleep 10
  #     '';
  #   };
  # };
  ...
  systemd.services."proxy-socks5" = {
    ...
    serviceConfig = {
      User = "rok";
      ExecStart = ''
        /run/current-system/sw/bin/ssh -v -D 1337 -q -C root@oci-xnzm1001-002 "sh -c 'while :; do date; sleep 2073600; done'"
      '';
    };
  };
  ...
  services.nfs.server.exports = ''
    /mnt/rok-chatreey-t9/cache 192.168.0.0/24(rw,nohide,insecure,no_subtree_check,all_squash,anonuid=0,anongid=0,fsid=9eebb861-b9b3-415d-a2ff-bd0ab28ff29a)
  '';
}
