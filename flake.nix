{
  inputs = {
    ...
    ffmpeg-bin = {
      url = "github:aca/ffmpeg-builds.nix";
    ...
    zmx = {
      url = "github:neurosnap/zmx/main?shallow=1";
      # inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    # # staging carries svt-av1 4.x ahead of unstable; source build is acceptable.
    # nixpkgs-staging.url = "github:NixOS/nixpkgs/staging?shallow=1";
  ...
  outputs =
    ...
    in
    {
      ...
      nixosConfigurations.oci-xnzm-a1 = nixpkgs.lib.nixosSystem rec {
        system = "aarch64-linux";
        specialArgs = { inherit inputs system; };
        modules = [
          ./all.configuration.nix
          ./overlay.nix
          ./oci-xnzm-a1.configuration.nix
          agenix.nixosModules.default
        ];
      };

      nixosConfigurations.oci-impx-a1 = nixpkgs.lib.nixosSystem rec {
        system = "aarch64-linux";
        specialArgs = { inherit inputs system; };
        modules = [
          ./all.configuration.nix
          ./overlay.nix
          ./oci-impx-a1.configuration.nix
          agenix.nixosModules.default
        ];
      };

      nixosConfigurations.oci-jkor-a1 = nixpkgs.lib.nixosSystem rec {
        system = "aarch64-linux";
        specialArgs = { inherit inputs system; };
        modules = [
          ./all.configuration.nix
          ./overlay.nix
          ./oci-jkor-a1.configuration.nix
          agenix.nixosModules.default
        ];
      };

      nixosConfigurations.tscm = nixpkgs.lib.nixosSystem rec {
        system = "aarch64-linux";
        specialArgs = { inherit inputs system; };
        modules = [
          ./all.configuration.nix
          ./overlay.nix
          ./tscm.configuration.nix
          ./neovim.nix
          agenix.nixosModules.default
