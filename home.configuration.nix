...
in {
  ...
  # }
  #
  # home.folk-uaru.ts.net {
  #         log {
  #                 output file /var/log/caddy/access-home.folk-uaru.ts.net.log
  #         }
  #
  #         respond "hello"
  # }
  #
  # jkor-matrix-ss.duckdns.org {
  #         log {
  #                 output file /var/log/caddy/access-jkor-matrix-ss.duckdns.org.log
  #         }
  #
  #         reverse_proxy http://archive-0.local:8009
  # }
  #
  # jkor-matrix.duckdns.org {
  #         log {
  #                 output file /var/log/caddy/access-jkor-matrix.duckdns.org.log
  #         }
  #
  ...
  services.caddy.virtualHosts."jkor-matrix.duckdns.org".extraConfig = ''
    reverse_proxy http://archive-0:8008
  '';
  services.caddy.virtualHosts."jkor-matrix-ss.duckdns.org".extraConfig = ''
    reverse_proxy http://archive-0:8009
  '';
  ...
  #     enable = true;
  #     settings = {
  #       cname=["torrent.rok-chatreey-t9,rok-chatreey-t9.leo-rudd.ts.net"];
  #       address=[
  #           "/rok-chatreey-t9.leo-rudd.ts.net/100.87.185.91"
