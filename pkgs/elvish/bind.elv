...
# set edit:insert:binding[Ctrl-E] = { tput reset > /dev/tty; nop ?(tmux clear-history 2>/dev/null); edit:redraw &full=$true }
set edit:insert:binding[Ctrl-E] = { edit:insert-raw 'werwer' }
