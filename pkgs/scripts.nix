{
  ...
  binscripts = builtins.mapAttrs (name: text: builtins.readFile ((builtins.toString ./.) + "/scripts/${name}")) (builtins.readDir ./scripts);
in {
  environment.systemPackages =
    [
      ...
      (pkgs.writeShellScriptBin "cp.rsyncdir" ''${pkgs.rsync}/bin/rsync -avhpb --suffix .bak "$1/" "$2/"'')
