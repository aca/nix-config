{
  ...
  home.file."${config.xdg.configHome}/qBittorrent/qBittorrent.conf" = {
    ...
    text = ''
      ...
      FileLogger\Path=/mnt/rok-chatreey-t9/cache/qBittorrent/logs
      ...
      Session\AlternativeGlobalDLSpeedLimit=8000
      Session\AlternativeGlobalUPSpeedLimit=250
      Session\BandwidthSchedulerEnabled=true
      Session\DefaultSavePath=/mnt/rok-chatreey-t9/cache/qBittorrent/done
      Session\DisableAutoTMMByDefault=false
      Session\ExcludedFileNames=
      Session\FinishedTorrentExportDirectory=/mnt/rok-chatreey-t9/cache/qBittorrent/done.torrent
      Session\GlobalDLSpeedLimit=6000
      Session\GlobalMaxRatio=-1
      Session\GlobalMaxSeedingMinutes=-1
      Session\GlobalUPSpeedLimit=250
      ...
      Session\Tags=plab
      Session\TempPath=/mnt/rok-chatreey-t9/cache/qBittorrent/tmp
      Session\TempPathEnabled=true
      Session\TorrentExportDirectory=/mnt/rok-chatreey-t9/cache/qBittorrent/tmp.torrent
      ...
      Proxy\IP=localhost
      Proxy\Password=
      Proxy\Port=@Variant(\0\0\0\x85\x5\x39)
      ...
      Scheduler\end_time=@Variant(\0\0\0\xf\x1\xee\x62\x80)
      Scheduler\start_time=@Variant(\0\0\0\xf\0\xa4\xcb\x80)
      WebUI\Address=0.0.0.0
      WebUI\AlternativeUIEnabled=false
      WebUI\AuthSubnetWhitelist=100.0.0.0/8, 192.168.0.0/24
      ...
      WebUI\Password_PBKDF2="@ByteArray(aYEFABoccPkpPnTPnqOlhg==:2W8QHGgQ4ZheMW39mYO0+jwcvz5lM2kPyLX6MtUGYG+czQhPk6HOc/CtaII6+pEMgT+5F/90xuoKrI+if2GA3g==)"
      WebUI\Port=4321
      ...
      AutoDownloader\SmartEpisodeFilter=
    '';
  };
}
