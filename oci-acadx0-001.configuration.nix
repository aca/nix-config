{
  ...
  # age.secrets."github.com__aca__oci-acadx0-002.age".file = ./secrets/github.com__aca__oci-acadx0-002.age;
  # services.github-runners.aca__oci-arm-host-capacity__oci-acadx0-002_001 = {
  #   enable = true;
  #   url = ''https://github.com/aca/oci-arm-host-capacity'';
  #   tokenFile = config.age.secrets."github.com__aca__oci-acadx0-002.age".path;
  #   replace = true;
  #   extraLabels = ["nix"];
  #   extraPackages = with pkgs; [
  #     php82
