# httpr://nixos.org/guides/nix-pills/
{
  ...
  # services.matrix-synapse.dataDir = "/home/rok/archive/jkor-matrix.duckdns.org";

  networking.extraHosts = ''
    192.168.0.12 archive-0.local
    192.168.0.15 seedbox.local
  '';

  age.secrets."synapse__registration_shared_secret.age".file = ./secrets/synapse__registration_shared_secret.age;
  age.secrets."synapse__registration_shared_secret.age".mode = "0777";
  services.matrix-synapse.extraConfigFiles = [
    config.age.secrets."synapse__registration_shared_secret.age".path
    (pkgs.writeText
  ...
  #     User = "rok";
  #     ExecStart = ''
  #       ${pkgs.unstable.qbittorrent-nox/bin/qbittorrent-nox}
  #     '';
  #   };
  # };
