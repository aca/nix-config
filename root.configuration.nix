...
in
{
  ...
  #   options = [
  #     "noatime"
  #     "x-systemd.mount-timeout=5s" # cap mount attempts at boot
  #     # "x-systemd.requires=network-online.target"
  #   ];
  # };
  #
  # fileSystems."/mnt/tor" = {
  #   device = "100.100.82.59:/mnt/tor";
  #   fsType = "nfs";
  #   # "x-systemd.device-timeout=10s"
  #   # x-systemd.automount
  #   # _netdev
  ...
  #   device = "100.100.82.59:/mnt/archive-0";
  #   fsType = "nfs";
  #   # "x-systemd.device-timeout=10s"
  #   # x-systemd.automount
  #   # _netdev
  ...
  services.printing = {
    ...
    drivers = with pkgs; [
      hplip # HP 프린터용
      cups-filters # 일반적인 프린터 필터

      cups-browsed
      # gutenprint # 기타 제조업체용
      # cnijfilter2 # 캐논 프린터용 (필요 시)
    ];
  };
}
